 						...
 						<div class="row">
 							...
 							<div class="col-md-6 bg-info my-5">
 								<form method="post">
									...
									<input type="text" name="sym" class="form-control" autocomplete="off" placeholder="Enter Symptons" value="<?php if(isset($_POST['sym'])) echo $_POST['sym']; ?>">
									<br>
									<input type="submit" name="book" class="btn btn-success my-2" value="Book Appointment" style="margin-left: 225px;">
								</form>
 							</div>
 							<div class="col-md-3"></div>
 						</div>
